<div class="row">
    <div class="col-md-12">
        <h4 class="m-b-lg">
            Ürün Listesi
            <a href="<?php echo base_url("product/new_form"); ?>" class="btn btn-outline btn-primary pull-right"><i class="fa fa-plus"></i> Yeni Ekle</a>
        </h4>
                ...
                <tbody>
                    <?php foreach ($items as $item) {?>
                        <tr>
                            ...
                            <td>
                                <a href="<?php echo base_url("product/delete/$item->id"); ?>" class="btn btn-xs btn-outline btn-warning"><i class="fa fa-trash"></i> Sil</a>
