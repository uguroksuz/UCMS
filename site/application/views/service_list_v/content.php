        ...
        <div class="container">
          <div class="row">
            ...
            <div class="main col-12">
              ...
              <!-- page-title end -->
              <p class="lead">Size sunduğumuz gizmetlerimiz.</p>
              ...
              foreach ($services as $service) { ?>
                <div class="image-box style-4 light-gray-bg">
                    ...
                    <div class="col-lg-6">
                        ...
                        <img src="<?php echo base_url("panel/uploads/services_v/$service->img_url"); ?>" alt="">
                    ...
                    <div class="col-lg-6">
                        <div class="overlay-container">
                        <img src="<?php echo base_url("panel/uploads/references_v/$service->img_url"); ?>" alt="">
                        <div class="overlay-to-top">
                            <p class="small margin-clear"><em><?php echo $service->title; ?></em></p>
                        </div>
                        </div>
