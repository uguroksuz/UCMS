...
<div class="container">
    ...
    <div class="col-lg-8 text-center pv-20">
        ...
        <p class="lead text-center">Bizi arayabilir yada bir mail gönderebilirsiniz.</p>
...
<div class="container">
    ...
    <div class="main col-12 space-bottom">
        ...
        <div class="row">
        <div class="col-lg-6">
            <p>Aşağıdaki formu kullanarak bize mesaj gönderebilirsiniz.</p>
            ...
            <form class="margin-clear" action="<?php echo base_url("mesaj_gonder");?>" method="post">
...
<div class="container">
    ...
    <div class="col-12">
        ...
        <div class="row justify-content-lg-center">
            ...
            <p>Kampanya, yenilik ve fırsatlardan haberdar olmak için abone olun.</p>
            <div class="separator"></div>
