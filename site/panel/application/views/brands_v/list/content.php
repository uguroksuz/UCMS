    ...
    <div class="col-md-12">
        <h4 class="m-b-lg">
            ...
            <?php if (isAllowedWriteModule()) {?>
                <a href="<?php echo base_url("brands/new_form"); ?>" class="btn btn-sm btn-outline btn-primary pull-right"><i class="fa fa-plus"></i> Yeni Marka Ekle</a>
            <?php }?> 
        </h4>
    ...
    <div class="col-md-12">
        <div class="widget p-lg">
            ...
            <div class="alert alert-info text-center">
                <p>Herhangi bir veri bulunmamaktadır. Eklemek için lütfen <a href="<?php echo base_url("brands/new_form"); ?>">tıklayınız.</a></p>
            </div> 
            <?php } else{ ?>
