                ...
                <form action="<?php echo base_url("services/update/$item->id"); ?>" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-md-1 image_upload_container">
                            <img width="50" src="<?php echo get_picture($viewFolder, $item->img_url, "350x217");?>" alt="<?php echo $item->img_url; ?>">
                        </div>
                    ...
                    <a href="<?php echo base_url("services"); ?>" class="btn btn-outline btn-danger btn-md">İptal</a>
                </form>
            </div><!-- .widget-body -->
        </div><!-- .widget -->
    </div><!-- END column -->
