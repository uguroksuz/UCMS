            ...
            <div class="widget-body">
                <form action="<?php echo base_url("testimonials/update/$item->id"); ?>" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" id="exampleInputEmail1" placeholder="İsim Soyisim" name="full_name"  value="<?php echo $item->full_name; ?>">
                    ...
                    <div class="form-group">
                        <label>Şirket</label>
                        <input class="form-control" id="exampleInputEmail1" placeholder="Şirket" name="company"  value="<?php echo $item->company; ?>">
                        <?php if (isset($form_error)) { ?>
                    ...
                    <div class="row">
                        <div class="col-md-1 image_upload_container">
                            <img width="50" src="<?php echo get_picture($viewFolder, $item->img_url, "90x90"); ?>" alt="<?php echo $item->img_url; ?>">
                        </div>
